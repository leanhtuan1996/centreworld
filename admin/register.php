...
?>
  ...
  <form action="" method="POST"enctype="multipart/form-data" class="form-horizontal row-fluid"> 
      ...
      <div class="form-group">
						...
						<div class="controls">
							<input type="password" name="password" placeholder="Nhập mật khẩu(*)" class="form-control" required data-validation-required-message="This field is required"minlength="6"> </div>
					</div>
					<div class="form-group">
						<h5>Nhập lại mật khẩu<span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="password" name="password2"  placeholder="Nhập lại mật khẩu(*)" data-validation-match-match="password" class="form-control" required> </div>
					</div>
      <div class="row">
        <div class="col-12">
          <div class="checkbox">
