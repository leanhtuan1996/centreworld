   ...
   <div class="box">
	  <div class="box-header">
		<h3 class="box-title">Hóa đơn thanh toán</h3>
	  </div>
	  <!-- /.box-header -->
	  <div class="box-body">
	
			          <table id="bill_table"  class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
		  <thead>
			  <tr>
				  <th>Vị trí</th>
				  <th>Lương</th>
