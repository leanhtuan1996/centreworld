<?php  
			...
			for ($i=0; $i < count($bill); $i++){
			  ...
			  <td>
              <button type="button" class="btn btn-block btn-warning " onclick="location.href='index.php?page=pay&id_b=<?php echo $id_b ?>';"><i class="fa fa-credit-card" aria-hidden="true"></i> Hóa đơn</button>
			  </td>          
				<?php
			}
		  ?>
